...
from .views import Company_Home_View, Login_view, Logout_view, Add_Employee_view, Forgot_password, Add_new_password, Otp_match, Add_new_job, ViewJob, EditJob, DeleteJob
app_name = "Company"
